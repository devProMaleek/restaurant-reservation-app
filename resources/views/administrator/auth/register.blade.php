<x-administrator-guest-layout>
  <x-admin-create-account-card>
    <x-slot name="img">
      <x-admin-image src="{{ asset('assets/img/create-account-office.jpeg') }}" class="dark:hidden">
      </x-admin-image>
      <x-admin-image src="{{ asset('assets/img/create-account-office-dark.jpeg') }}" class="hidden dark:block">
      </x-admin-image>
    </x-slot>

    <x-admin-create-account-form>
      ...
      <form method="POST" action="{{ route('administrator.register') }}">
        ...
        <!-- Name -->
        <div>
          <x-label for="name" class="block text-sm">
            <x-admin-span :value="__('Full Name')"></x-admin-span>
        ...
        <div class="flex items-center justify-end mt-4">
          <a class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="{{ route('administrator.login') }}">
