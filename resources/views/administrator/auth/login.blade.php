<x-administrator-guest-layout>
  <x-admin-auth-card>
    <x-slot name="img">
      <x-admin-image src="{{ asset('assets/img/login-office.jpeg') }}" class="dark:hidden">
      </x-admin-image>
      <x-admin-image src="{{ asset('assets/img/login-office-dark.jpeg') }}" class="hidden dark:block"></x-admin-image>
    </x-slot>
